  ...
  return <div 
    ...
    >
     <div className="illustration">
        <img src="assets/img/banner-bg-1.png" 
        className="one" alt="" />
        <img src="assets/img/banner-bg-2.png" 
        className="two" alt="" />
        <img src="assets/img/banner-map.png" 
        className="three" alt="" />
     </div> 
